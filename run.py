...
# app root director(py notation) a way of wrapping functions. if we try to browse through the rout directory indicated by "/" - the functions underneath is triggerd
@app.route("/")
def index():
